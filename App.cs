...
namespace QuickClash
{
    ...
    internal class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            //button.LargeImage = new BitmapImage(new Uri("pack://application:,,,/ClashDetection;component/Resources/architech-working-(1).png"));
            ...
            //button2.LargeImage = new BitmapImage(new Uri("pack://application:,,,/ClashDetection;component/Resources/check-list-(1).png"));
            ...
            //button3.LargeImage = new BitmapImage(new Uri("pack://application:,,,/ClashDetection;component/Resources/3d-(1).png"));
            ...
            //button4.LargeImage = new BitmapImage(new Uri("pack://application:,,,/ClashDetection;component/Resources/pipes-angles-(1).png"));
            ...
            //button5.LargeImage = new BitmapImage(new Uri("pack://application:,,,/ClashDetection;component/Resources/broom-(1).png"));
            ...
            //button6.LargeImage = new BitmapImage(new Uri("pack://application:,,,/ClashDetection;component/Resources/edit-(1).png"));
